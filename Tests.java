...
public class Tests {
	...
	public void testGraphMisc() {
		...
		assertTrue(TestingSupport.correctResults("testGraphMisc.txt", answer));
	}
	...
	public void testBFS() {
		...
		assertTrue(TestingSupport.correctResults("testBFS.txt", results.toString()));
	}
	...
	public void testDFS() {
		...
		assertTrue(TestingSupport.correctResults("testDFS.txt", results.toString()));
	}
	...
	public void testDijkstras() {
		...
		assertTrue(TestingSupport.correctResults("testDijkstras.txt", answer));
	}
